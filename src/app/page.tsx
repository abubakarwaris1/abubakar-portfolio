      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center p-6 pointer-events-none">
        <div className="glass-nav border border-white/5 dark:border-white/10 rounded-full px-6 py-2 flex items-center gap-8 pointer-events-auto shadow-2xl">
          ...
          <div className="flex items-center gap-6">
            <a className="text-xs font-medium uppercase tracking-widest text-primary hover:text-primary/80 transition-colors" href="#">Home</a>
            <a className="text-xs font-medium uppercase tracking-widest text-slate-400 hover:text-white transition-colors" href="#projects">Projects</a>
